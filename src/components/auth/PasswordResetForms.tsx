...
const FIELD =
  "w-full rounded-full border border-black/10 bg-white px-4 py-2.5 text-[15px] text-[#0a0a0a] placeholder-[#0a0a0a]/35 outline-none transition-colors focus-visible:ring-4 focus-visible:ring-[#0a0a0a]/15 focus-visible:border-[#0a0a0a] disabled:opacity-60";
...
export function ForgotPasswordForm({ portal, backHref }: { portal: boolean; backHref: string }) {
  ...
  return (
    <Shell title="Reset your password">
      ...
      <Link
        href={backHref}
        className="mt-6 inline-block text-[14px] font-semibold text-[#0a0a0a]/60 hover:text-[#0a0a0a] py-1.5"
      >
        Back to sign in
      </Link>
    </Shell>
