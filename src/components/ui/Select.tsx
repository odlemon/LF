  ...
  return (
    <div className={`flex flex-col gap-1.5 w-full relative ${className}`} ref={dropdownRef}>
      ...
      <button
        ...
        } rounded-full text-xs font-bold text-gray-800 transition-all focus:outline-none focus:ring-2 disabled:opacity-50 disabled:bg-gray-50 cursor-pointer`}
      >
        <span className={selectedOption ? "text-gray-800" : "text-gray-400 font-semibold"}>
      ...
      {isOpen && (
        <div className="absolute left-0 right-0 top-full mt-2 bg-white border border-gray-150 rounded-2xl shadow-xl z-50 overflow-hidden max-h-56 overflow-y-auto rates-scrollable animate-fade-in-up">
          <div className="py-1">
            {options.length === 0 ? (
              <div className="px-5 py-3 text-xs font-semibold text-gray-400 text-center">
