...
export const textareaClassName =
  "w-full px-5 py-2.5 border border-border rounded-2xl bg-field text-ink text-sm font-semibold placeholder:text-ink/60 outline-none transition-all duration-200 focus:ring-2 focus:ring-primary/20 focus:border-primary/50 focus:bg-surface resize-none disabled:opacity-60 disabled:cursor-not-allowed";
