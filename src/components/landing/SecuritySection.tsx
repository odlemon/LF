    ...
    <section id="security" className="relative w-full overflow-hidden bg-[#fefefc] text-[#0a0a0a]">
      ...
      <div className={`${MARKETING_SHELL} pt-20 sm:pt-28 pb-20 sm:pb-28`}>
        <SectionHeader
          ...
          title="Enterprise-grade security and controls"
          description="Lysp is built on a non-negotiable principle: protecting the security and confidentiality of your firm’s pricing data. We’ve designed the platform from the ground up to safeguard the most sensitive information - rates, OCGs, realization, and negotiation history."
        />

        <div className="mt-12 sm:mt-14 grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-6 gap-x-4 gap-y-8 sm:gap-x-6 lg:gap-8 place-items-start sm:place-items-center">
          {SECURITY_CERTIFICATIONS.map((cert) => (
            <a
              ...
              className="group flex flex-col items-start sm:items-center gap-3 transition-transform duration-200 hover:-translate-y-1 cursor-pointer"
            ...
            >
              ...
              <span className="text-[11px] sm:text-[13px] font-semibold tracking-tight text-left sm:text-center text-[#0a0a0a]/70 group-hover:text-[#0a0a0a] group-hover:underline underline-offset-4 decoration-black/20 max-w-[5.5rem] sm:max-w-none">
                {cert.shortLabel}
              </span>
            </a>
          ))}
        ...
        <div className="mt-12 sm:mt-14 flex flex-col items-start gap-4">
          <Link
            href="/security"
