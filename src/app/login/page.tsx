...
function LoginForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full space-y-5">
      ...
      {/* Temporarily disabled -- the identity-provider side of this isn't ready to demo yet.
          A real HTML disabled button, not just a dimmed style: it cannot be focused or
          clicked at all. Re-enabling is restoring an onClick, not removing this comment. */}
      <button
        type="button"
        disabled
        aria-disabled="true"
        className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-full border border-black/[0.1] bg-white px-6 py-[0.95rem] text-[15px] font-semibold text-[#0a0a0a]/35 cursor-not-allowed"
      >
