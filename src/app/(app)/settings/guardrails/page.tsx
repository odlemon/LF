...
export default function GuardrailsPage() {
  ...
  const inputStyles = (active: boolean) =>
    `w-full px-5 py-2.5 border rounded-full text-sm font-semibold transition-all duration-200 ${
      active
        ? "bg-white border-primary/40 focus:ring-2 focus:ring-primary/20 focus:border-primary text-gray-900 cursor-text"
        : "bg-gray-50/60 border-gray-200/50 text-gray-650 cursor-not-allowed select-none"
    }`;

  return (
    <div className="p-8 max-w-5xl w-full mx-auto flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Pricing Guardrails</h1>
      ...
      <div className="bg-gradient-to-r from-primary/5 via-primary/[0.02] to-transparent border border-primary/10 rounded-2xl p-6 flex items-start gap-4">
        ...
        <div>
          <h2 className="text-sm font-bold text-gray-900">What are Pricing Guardrails?</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <form onSubmit={handleSave} className="bg-white rounded-2xl border border-gray-200/60 shadow-sm p-6 lg:col-span-2 flex flex-col gap-6">
          <div className="flex items-center justify-between pb-3 border-b border-gray-100">
            ...
            {!isEditing ? (
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-bold text-gray-650 bg-gray-50 hover:bg-gray-100 border border-gray-200/60 transition-all cursor-pointer select-none"
              >
                <HiLockClosed className="w-3.5 h-3.5 text-gray-500" />
          ...
          <div className="p-5 bg-gray-50/40 rounded-2xl border border-gray-100 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <span className="text-[10px] text-gray-550 leading-normal">
          ...
          <div className="p-5 bg-gray-50/40 rounded-2xl border border-gray-100 flex flex-col gap-4">
            ...
            <div className="bg-white rounded-xl border border-gray-150 p-4 mt-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div className="p-3.5 bg-emerald-50/20 border border-emerald-100 rounded-2xl flex flex-col gap-1">
                  <span className="text-[9px] font-extrabold text-emerald-700 bg-emerald-55 self-start px-2 py-0.5 rounded-lg uppercase tracking-wider">
                    Auto-Approve
                  </span>
                  <span className="text-[13px] font-extrabold text-gray-900 mt-1">0% to {discountAutoMaxPct}%</span>
                  <span className="text-[10px] text-gray-500 leading-normal mt-0.5">Cleared instantly without additional oversight.</span>
                </div>
                ...
                <div className="p-3.5 bg-amber-50/20 border border-amber-100 rounded-2xl flex flex-col gap-1">
                  ...
                  <span className="text-[13px] font-extrabold text-gray-900 mt-1">{discountAutoMaxPct}% to {discountPartnerMaxPct}%</span>
                  <span className="text-[10px] text-gray-500 leading-normal mt-0.5">Requires partner authorization to onboard.</span>
                </div>
                ...
                <div className="p-3.5 bg-purple-50/20 border border-purple-100 rounded-2xl flex flex-col gap-1">
                  ...
                  <span className="text-[13px] font-extrabold text-gray-900 mt-1">Above {discountPartnerMaxPct}%</span>
                  <span className="text-[10px] text-gray-500 leading-normal mt-0.5">Requires global Pricing Committee review.</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              <input
                ...
                value="COMMITTEE"
                disabled
                className="w-full pl-5 pr-10 py-2.5 bg-gray-100 border border-gray-200 rounded-full text-sm text-gray-500 font-bold tracking-wider cursor-not-allowed select-none"
              />
              <HiLockClosed className="absolute right-4 top-3.5 text-gray-400 w-4 h-4" />
            </div>
          ...
          <div
            className={`flex justify-end gap-3 pt-4 border-t border-gray-100 transition-all duration-300 ${
        ...
        <div className="bg-white rounded-2xl border border-gray-200/60 shadow-sm p-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-6 mt-1">
            {/* Visual Gauge Bar */}
            <div className="h-4 w-full rounded-full bg-gray-100 overflow-hidden flex shadow-inner border border-gray-200/30">
              <div
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="p-4 bg-rose-50/40 border border-rose-100/60 rounded-2xl flex gap-3">
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <span className="text-xs font-bold text-gray-900 mt-0.5">Margins 0% to {rejectLimit}%</span>
              ...
              <div className="p-4 bg-amber-50/40 border border-amber-100/60 rounded-2xl flex gap-3">
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <span className="text-xs font-bold text-gray-900 mt-0.5">Margins {rejectLimit}% to {warningLimit}%</span>
                  <span className="text-[10px] text-gray-500 mt-0.5 leading-normal">
              ...
              <div className="p-4 bg-emerald-50/40 border border-emerald-100/60 rounded-2xl flex gap-3">
                ...
                <div className="flex flex-col gap-0.5">
                  <span className="text-[10px] font-extrabold text-emerald-800 uppercase tracking-wide">Safe Approval Zone</span>
                  <span className="text-xs font-bold text-gray-900 mt-0.5">Margins above {warningLimit}%</span>
                  <span className="text-[10px] text-gray-500 mt-0.5 leading-normal">
