...
export default function FirmDetailsPage() {
  ...
  if (isLoading && !firm) {
    return (
      <div className="p-8 max-w-3xl w-full mx-auto flex flex-col gap-6 animate-pulse">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-150 flex flex-col gap-4">
  ...
  return (
    <div className="p-8 max-w-3xl w-full mx-auto flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Firm Settings</h1>
        <p className="text-sm text-gray-500 mt-1">Configure your enterprise firm profile, registration details, and localization parameters.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200/60 overflow-hidden">
        <div className="p-6 border-b border-gray-100 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="inline-flex items-center px-2 py-0.5 rounded-lg text-[10px] font-bold bg-emerald-50 text-emerald-700 border border-emerald-250/20 uppercase tracking-wide">
              {firm?.status}
            </span>
          </div>
        ...
        <form onSubmit={handleSave} className="p-6 flex flex-col gap-5">
          ...
          <div
            className={`flex justify-end gap-3 mt-4 pt-4 border-t border-gray-100 transition-all duration-300 ${
