...
export function EngagementPackDocument({ pack, section = "letter" }: Props) {
  ...
  return (
    <div className="engagement-doc mx-auto w-full max-w-[720px] bg-[#f7f4ef] text-ink shadow-[0_1px_0_rgba(0,0,0,0.04)]">
      <div
        className="engagement-letter-body print:bg-white px-8 py-10 text-[13.5px] leading-[1.7] text-ink/85 sm:px-12 sm:py-12 [&_h1]:mb-4 [&_h1]:mt-6 [&_h1]:text-lg [&_h1]:font-semibold [&_h1]:tracking-tight [&_h1]:text-ink [&_h2]:mb-2 [&_h2]:mt-7 [&_h2]:text-[11px] [&_h2]:font-bold [&_h2]:uppercase [&_h2]:tracking-[0.14em] [&_h2]:text-ink/45 [&_p]:mb-3 [&_strong]:font-semibold [&_strong]:text-ink [&_table]:mt-4 [&_table]:w-full [&_table]:border-collapse [&_td]:border-b [&_td]:border-ink/8 [&_td]:py-2 [&_td]:align-top [&_th]:border-b [&_th]:border-ink/15 [&_th]:pb-2 [&_th]:text-left [&_th]:text-[10px] [&_th]:font-bold [&_th]:uppercase [&_th]:tracking-[0.12em] [&_th]:text-ink/40 [&_.letter-head]:mb-8 [&_.letter-head]:border-b [&_.letter-head]:border-ink/10 [&_.letter-head]:pb-6 [&_.firm-name]:text-lg [&_.firm-name]:font-semibold [&_.firm-name]:tracking-tight [&_.firm-name]:text-ink [&_.firm-address]:mt-1 [&_.firm-address]:text-xs [&_.firm-address]:text-ink/45 [&_.letter-date]:mt-3 [&_.letter-date]:text-xs [&_.letter-date]:text-ink/50 [&_.salutation]:mb-4 [&_.matter-ref]:mb-5 [&_.signature-block]:mt-10 [&_.signature-block]:grid [&_.signature-block]:gap-8 [&_.signature-block]:sm:grid-cols-2 [&_.sig-label]:mb-6 [&_.sig-label]:text-xs [&_.sig-label]:font-semibold [&_.sig-label]:text-ink [&_.sig-line]:mb-2 [&_.sig-meta]:text-xs [&_.sig-meta]:text-ink/45 [&_.annex]:mt-12 [&_.annex]:border-t [&_.annex]:border-ink/10 [&_.annex]:pt-8 [&_.num]:text-right [&_.num]:tabular-nums"
